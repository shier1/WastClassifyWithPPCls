...
def MobileNetV2_x0_25_CBAM(pretrained=False, use_ssld=False, **kwargs):
...
def MobileNetV2_x0_5_CBAM(pretrained=False, use_ssld=False, **kwargs):
...
def MobileNetV2_x0_75_CBAM(pretrained=False, use_ssld=False, **kwargs):
...
def MobileNetV2_CBAM(pretrained=False, use_ssld=False, **kwargs):
...
def MobileNetV2_x1_5_CBAM(pretrained=False, use_ssld=False, **kwargs):
...
def MobileNetV2_x2_0_CBAM(pretrained=False, use_ssld=False, **kwargs):
